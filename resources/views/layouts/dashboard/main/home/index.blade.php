        ...
        <div class="flex flex-wrap pb-3 mx-4 md:mx-24 lg:mx-0">
            ...
            <div class="w-full p-2 lg:w-1/4 md:w-1/2">
                <div
                    ...
                    <h1 class="text-3xl sm:text-4xl xl:text-5xl font-bold text-gray-700 mt-12 group-hover:text-gray-50">42.34k</h1>
                    <div class="flex flex-row justify-between group-hover:text-gray-200">
            ...
            <div class="w-full p-2 lg:w-1/4 md:w-1/2">
                <div
                    ...
                    <h1 class="text-3xl sm:text-4xl xl:text-5xl font-bold text-gray-700 mt-12 group-hover:text-gray-50">00%
                    </h1>
                    <div class="flex flex-row justify-between group-hover:text-gray-200">
